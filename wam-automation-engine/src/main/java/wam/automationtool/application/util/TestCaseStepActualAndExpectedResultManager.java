  ...
  public static ActualAndExpectedResultDto getActualAndExpectedResult(
    ...
    switch (testCaseStepType) {
      ...
      case A_LOG_FILE_READING_START:
        passActualResultTemplate =
            "log reading started successfully: logFile: {"
                + TCS_RESULT_LOG_FILE
                + "}, "
                + "logFileLocation: {"
                + TCS_RESULT_LOG_FILE_LOCATION
                + "}, "
                + "tempLogFileLocation: {"
                + TCS_RESULT_TEMP_LOG_FILE_LOCATION
                + "}, "
                + "tempLogFileName: {"
                + TCS_RESULT_TEMP_LOG_FILE_NAME
                + "}.";
        failActualResultTemplate =
            "failed to start log reading: logFile: {"
                + TCS_RESULT_LOG_FILE
                + "}, "
                + "logFileLocation: {"
                + TCS_RESULT_LOG_FILE_LOCATION
        ...
        expectedResultTemplate =
            "log reading should be started for logFile: {"
                + TCS_RESULT_LOG_FILE
                + "} "
                + "from logFileLocation: {"
                + TCS_RESULT_LOG_FILE_LOCATION
                + "}.";
        break;
      case A_LOG_FILE_READING_END:
        passActualResultTemplate =
            "log reading ended successfully: logFile: {"
                + TCS_RESULT_LOG_FILE
                + "}, "
                + "logFileLocation: {"
                + TCS_RESULT_LOG_FILE_LOCATION
                ...
                + "}.";
        failActualResultTemplate =
            "failed to end log reading: logFile: {"
                + TCS_RESULT_LOG_FILE
                + "}, "
                + "logFileLocation: {"
                + TCS_RESULT_LOG_FILE_LOCATION
                + "}.";
        expectedResultTemplate =
            "log reading should be ended for logFile: {"
                + TCS_RESULT_LOG_FILE
                + "} "
                + "from logFileLocation: {"
                + TCS_RESULT_LOG_FILE_LOCATION
      ...
      case A_LOG_FILE_LINE_READ:
        ...
        failActualResultTemplate =
            "failed to read log line or validate assertion: "
                ...
                + "}.";
        expectedResultTemplate =
            "log reading should locate a matching line in logFile: {"
                + TCS_RESULT_LOG_FILE
                + "} "
                + "(tempLogFileName: {"
                + TCS_RESULT_TEMP_LOG_FILE_NAME
                + "}) "
                + "that matches includeRegex: {"
                + TCS_RESULT_INCLUDE_REGEX
                + "} "
                + "and does not match excludeRegex: {"
                + TCS_RESULT_EXCLUDE_REGEX
                + "}; "
                + "then actionRegex: {"
                + TCS_RESULT_ACTION_REGEX
                + "} should extract group index "
                + "{"
                + TCS_RESULT_REGEX_GROUP_INDEX_NUMBER
                + "} and equal logReadAssertValue: "
                + "{"
                + TCS_RESULT_LOG_READ_ASSERT_VALUE
                + "}.";
        break;
      case A_LOG_FILE_EXTRACT:
        passActualResultTemplate =
            "Log file extract completed successfully: logFile: {"
                + TCS_RESULT_LOG_FILE
                + "}, "
                + "logFileLocation: {"
                + TCS_RESULT_LOG_FILE_LOCATION
                ...
                + "}.";
        failActualResultTemplate =
            "Log file extract failed: logFile: {"
                + TCS_RESULT_LOG_FILE
                + "}, "
                + "logFileLocation: {"
                + TCS_RESULT_LOG_FILE_LOCATION
                ...
                + "}.";
        expectedResultTemplate =
            "System should extract the log file: {"
                + TCS_RESULT_LOG_FILE
                + "} "
                + "from logFileLocation: {"
                + TCS_RESULT_LOG_FILE_LOCATION
                + "} "
                + "and create tempLogFileName: {"
                + TCS_RESULT_TEMP_LOG_FILE_NAME
                + "}.";
        break;
      case A_LOG_FILE_DELETE:
        passActualResultTemplate =
            "Temp log file deleted successfully: tempLogFileName: {"
                + TCS_RESULT_TEMP_LOG_FILE_NAME
                + "}, "
                + "logFile: {"
                + TCS_RESULT_LOG_FILE
                ...
                + "}.";
        failActualResultTemplate =
            "Failed to delete temp log file: logFile: {"
                + TCS_RESULT_LOG_FILE
                + "}, "
                + "logFileLocation: {"
                + TCS_RESULT_LOG_FILE_LOCATION
                + "}.";
        expectedResultTemplate =
            "Temp log file should be deleted for logFile: {"
                + TCS_RESULT_LOG_FILE
                + "} "
                + "from logFileLocation: {"
                + TCS_RESULT_LOG_FILE_LOCATION
      ...
      case A_REMOVE_EXECUTION_CACHE:
        passActualResultTemplate =
            "Execution cache was removed successfully for execution id: {"
                + TCS_RESULT_EXECUTION_ID
                + "}.";
        failActualResultTemplate =
            "Failed to remove the execution cache for execution id: {"
                + TCS_RESULT_EXECUTION_ID
                + "}.";
        expectedResultTemplate =
            "The cache entry for execution id: {"
                + TCS_RESULT_EXECUTION_ID
                + "} should no longer exist.";
        break;
      case A_ADD_CACHE_ITEM:
        passActualResultTemplate =
            "Cache item was added successfully for key: {"
                ...
                + "}.";
        failActualResultTemplate =
            "Failed to add the cache item for key: {"
                + TCS_RESULT_STRING_CACHE_MAP_KEY
                + "}, "
                + "along with its corresponding value: {"
                + TCS_RESULT_STRING_CACHE_MAP_VALUE
      ...
      case A_REMOVE_CACHE_ITEM:
        passActualResultTemplate =
            "Cache item was removed successfully for key: {"
                + TCS_RESULT_STRING_CACHE_MAP
                + "}, "
                + "along with its corresponding value.";
        failActualResultTemplate =
            "Failed to remove the cache item for key: {"
                + TCS_RESULT_STRING_CACHE_MAP
                + "}, "
                + "along with its corresponding value.";
        expectedResultTemplate =
      ...
      case W_OPEN_BROWSER:
        passActualResultTemplate =
            "Browser was opened successfully at URL: {"
                + TCS_RESULT_BROWSER_LINK
                + "}. "
                + "Browser type: {"
                + TCS_RESULT_WEB_DRIVER_TYPE
                + "}. "
                + "The driver was saved under the name: {"
                + TCS_RESULT_WEB_DRIVER_CACHE_NAME
                + "}.";
        failActualResultTemplate =
            "Failed to open the browser at URL: {"
                + TCS_RESULT_BROWSER_LINK
                + "} "
                + "using {"
                + TCS_RESULT_WEB_DRIVER_TYPE
                + "}. "
                + "The driver could not be saved under the name: {"
                + TCS_RESULT_WEB_DRIVER_CACHE_NAME
                + "}.";
        expectedResultTemplate =
